...
\chairperson{\textbf{Doctor} Duarte Nuno Jardim Nunes, Instituto Superior Técnico, Universidade de Lisboa}
\vogalone{\textbf{Doctor} Maria Luísa Torres Ribeiro Marques da Silva Coheur, Instituto Superior Técnico, Universidade de Lisboa}
\vogaltwo{\textbf{Doctor} Alberto Abad Gareta, Instituto Superior Técnico, Universidade de Lisboa}
\vogalthree{\textbf{Doctor} Mathew Magimai Doss, Idiap Research Institute, Martigny, Switzerland}
\vogalfour{\textbf{Doctor} Marco Matassoni, Fondazione Bruno Kesler Augmented Inteligence Center}
\vogalfive{\textbf{Doctor} Leibny Paola Garcia-Perera, Center for Language and Speech Processing (CLSP), Johns Hopkins University}
