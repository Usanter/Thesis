...
% Explain complexity of data collection
...
% explain that with data, problem solved
...
%The importance of having a large database of children's speech with high variability has been proved by \cite{asr-google}. Where the authors trained an automatic speech recognition model using a large in-house corpus of children's speech, comparable in size to an adult speech corpus. This system achieved state-of-the-art performances competitive with adult speech recognition systems.
