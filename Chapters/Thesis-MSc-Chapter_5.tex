...
\end{equation}
In our experimental setup, the traditional Adapter use approximately 12.6 million parameters. Therefore, the number of parameters used for the Shared-Adapter is about 1.1 million. This corresponds to a significant reduction, as the Shared-Adapter utilizes only 1\% of the parameter count compared to the traditional Adapter, which already represented approximately 11\% of the total parameters used in the entire model fine-tuning.
