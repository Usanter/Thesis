...
Scaled or Gated Adapters are a extension of the traditional residual Adapters \cite{hou2021exploiting}. A couple of works used it in different context, 
% The one we are intersted in is the Scalling one inspired by LORA
